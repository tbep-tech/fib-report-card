...
load(here::here("data", "precipitation", "daily_rain_stns_1995-2023.RData"))
```
...
show_enteromap(fibwetdry, yrsel = 2020, mosel = 8, wetdry = TRUE)
show_enteromap(fibwetdry, yrsel = 2020, mosel = 9, wetdry = TRUE)
show_enteromap(fibwetdry, yrsel = 2020, mosel = 10, wetdry = TRUE)
show_enteromap(fibwetdry, yrsel = 2020, mosel = 11, wetdry = TRUE)
show_enteromap(fibwetdry, yrsel = 2020, mosel = 12, wetdry = TRUE)
show_enteromap(fibwetdry, yrsel = 2021, mosel = 1, wetdry = TRUE)
show_enteromap(fibwetdry, yrsel = 2021, mosel = 2, wetdry = TRUE)
show_enteromap(fibwetdry, yrsel = 2021, mosel = 3, wetdry = TRUE)
show_enteromap(fibwetdry, yrsel = 2021, mosel = 4, wetdry = TRUE)
show_enteromap(fibwetdry, yrsel = 2021, mosel = 5, wetdry = TRUE)
```
...
show_enteromap(fibwetdry, yrsel = 2020, mosel = 8, wetdry = FALSE)
show_enteromap(fibdat, yrsel = 2020, mosel = 8, wetdry = FALSE)
# shapes don't match in this one - need to check the original mapping fn?
show_enteromap(fibdat, yrsel = 2020, mosel = 8)


show_enteromap(fibwetdry, yrsel = 2020, mosel = 3, wetdry = TRUE)
